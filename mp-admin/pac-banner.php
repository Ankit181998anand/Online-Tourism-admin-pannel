        ...
        <div class="card-content">
            ...
            <div class="table-responsive">
                <table class="table table-shopping">
                    ...
                    <tbody>
                      <?php
          $sqli =" SELECT * FROM `package_banner` " ;
                            ...
                            <td>
                              ...
                              <td class="td-actions text-right">
                                        <button type="button" rel="tooltip" class="btn btn-success" data-original-title="" title="">
                                          <a href="edit_pac_banner.php?id=<?php echo base64_encode($row['id']); ?>"><i class="material-icons">edit</i></a>
                                        </button>
                                        <button type="button" rel="tooltip" class="btn btn-danger" data-original-title="" title="">
                                            <a href="remove_pac_banner.php?id=<?php echo base64_encode($row['id']); ?>"><i class="material-icons">close</i></a>
                                        </button>
                                    </td>
    ...
    <div class="modal-dialog modal-notice">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="myModalLabel">Add Package Banner</h5>
            </div>
...
<!------------------------------------>
         ...
         if(isset($_FILES['image'])){
           ...
           if($file_size1 > 5097152) {
             $errors[]='Image 1 ,File size must be excately 5 MB';
           }
           ...
           if ($i_s1==1) {
             echo $i_s1;
                 $file_name1;
                 $sql="SELECT title from package_banner where title='$title''";
                 $row = $link->query($sql);
                 if($row->num_rows>0){
                   ?>
                   <script>
                   ...
                   $sql="INSERT INTO `package_banner`(`title`,`imagename`) VALUES ('$title','$file_name1')";
