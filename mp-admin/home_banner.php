                            ...
                            <td>
                              ...
                              <td class="td-actions text-right">
                                        <button type="button" rel="tooltip" class="btn btn-success" data-original-title="" title="">
                                          <a href="edit-home-banner.php?id=<?php echo base64_encode($row['id']); ?>"><i class="material-icons">edit</i></a>
                                        </button>
                                        <button type="button" rel="tooltip" class="btn btn-danger" data-original-title="" title="">
                                            <a href="remove-home-banner.php?id=<?php echo base64_encode($row['id']); ?>"><i class="material-icons">close</i></a>
                                        </button>
                                    </td>
    ...
    <div class="modal-dialog modal-notice">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="myModalLabel">Add Home Banner</h5>
            </div>
           ...
           if ($i_s1==1) {
             echo $i_s1;
                 ...
                 if($row->num_rows>0){
                   ...
                   $sql="INSERT INTO `home_banner`(`title`,`imagename`) VALUES ('$title','$file_name1')";
