            ...
            while ($row = $data->fetch_assoc()) {
              ...
              ?>
                        <tr>
                            ...
                            <td>
                              <img src="./middleware/media/images/<?php echo $row['imagename']; ?>" style="width:150px; height:150px;"  alt="">
                              </td>
                              <td class="td-actions text-right">
                                        <button type="button" rel="tooltip" class="btn btn-success" data-original-title="" title="">
                                          <a href="edit-services.php?id=<?php echo base64_encode($row['id']); ?>"><i class="material-icons">edit</i></a>
                                        </button>
    ...
    <div class="modal-dialog modal-notice">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="myModalLabel">Add Servicees</h5>
            </div>
            <div class="modal-body">
              <form method="post" action="" enctype="multipart/form-data">
                      ...
                      <div class="fileinput-new thumbnail">
                        <label class="control-label">Service Image(900*300)px</label>
             ...
             echo $i_s1;
                 ...
                 if($row->num_rows>0){
                   ...
                   setTimeout(function() {
                     swal({
                       title: "Error",
                       text: "service already added,for changes please edit it.",
                       type: "error",
                   ...
                   $sql="INSERT INTO `services`(`title`,`imagename`) VALUES ('$title','$file_name1')";
