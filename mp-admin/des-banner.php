 ...
 ?>
    ...
    <div class="card">
        ...
        <div class="card-content">
            <h4 class="card-title">Destination Banner</h4>
            ...
            <div class="table-responsive">
                <table class="table table-shopping">
                    ...
                    <tbody>
                      <?php
          $sqli =" SELECT * FROM `destination_banner` " ;
            ...
            while ($row = $data->fetch_assoc()) {
              ...
              ?>
                        <tr>
                            ...
                            <td>
                              <img src="./middleware/media/images/<?php echo $row['imagename']; ?>" style="width:700px; height:300px;"  alt="">
                              </td>
                              <td class="td-actions text-right">
                                        <button type="button" rel="tooltip" class="btn btn-success" data-original-title="" title="">
                                          <a href="edit_des_banner.php?id=<?php echo base64_encode($row['id']); ?>"><i class="material-icons">edit</i></a>
                                        </button>
                                        <button type="button" rel="tooltip" class="btn btn-danger" data-original-title="" title="">
                                            <a href="remove_des_banner.php?id=<?php echo base64_encode($row['id']); ?>"><i class="material-icons">close</i></a>
                                        </button>
                                    </td>
    ...
    <div class="modal-dialog modal-notice">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="myModalLabel">Add Destination Banner</h5>
            </div>
            <div class="modal-body">
              <form method="post" action="" enctype="multipart/form-data">
                      ...
                      <div class="fileinput-new thumbnail">
                        <label class="control-label">Banner Image(900*300)px</label>
...
<!------------------------------------>
         ...
         if(isset($_FILES['image'])){
           ...
           if ($i_s1==1) {
             echo $i_s1;
                 $file_name1;
                 $sql="SELECT title from destination_banner where title='$title''";
                 $row = $link->query($sql);
                 if($row->num_rows>0){
                   ?>
                   <script>
                   setTimeout(function() {
                     swal({
                       title: "Error",
                       text: "Banner already added,for changes please edit it.",
                       type: "error",
                   ...
                   $sql="INSERT INTO `destination_banner`(`title`,`imagename`) VALUES ('$title','$file_name1')";
                   if(mysqli_query($link, $sql)){
                  exit(header('location:des-banner.php'));
                   } else{
                     ?>
                     <script>
                     setTimeout(function() {
