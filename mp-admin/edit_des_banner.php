...
include_once './assets/includes/header.php';
 $sqli =$link->query("SELECT * FROM `destination_banner` WHERE id='$id'") ;
 if ($sqli->num_rows > 0) {
	...
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-content">
				<h4 class="card-title">Edit Destination Banner (<?php echo $data['title']; ?>)</h4>
        <div class="float-right">
          <a href="des-banner.php"><button type="button" class="btn btn-danger" name="button">Back</button></a>
        ...
        if(isset($_FILES['image'])){
          ...
          if ($i_s1==1) {
            $sql="UPDATE `destination_banner` SET `title`='$title',`imagename`='$file_name1' WHERE id='$id'";
