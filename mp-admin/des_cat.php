 ...
 ?>
    ...
    <div class="card">
        ...
        <div class="card-content">
            <h4 class="card-title">Destination Categories</h4>
            ...
            <div class="table-responsive">
                <table class="table table-shopping">
                    ...
                    <tbody>
                      <?php
          $sqli =" SELECT * FROM `cat_destination` " ;
                            ...
                            <td><?php echo $row['name']; ?></td>
                              ...
                              <td class="td-actions">
                                        <button type="button" rel="tooltip" class="btn btn-success" data-original-title="" title="">
                                          <a href="edit_des_cat.php?id=<?php echo base64_encode($row['id']); ?>"><i class="material-icons">edit</i></a>
                                        </button>
                                        <button type="button" rel="tooltip" class="btn btn-danger" data-original-title="" title="">
                                            <a href="remove_des_cat.php?id=<?php echo base64_encode($row['id']); ?>"><i class="material-icons">close</i></a>
                                        </button>
                                    </td>
...
<!------------------------------------>
         ...
         $name = mysqli_real_escape_string($link,$_REQUEST['name']);
                 $sql="SELECT name from cat_destination where name='$name''";
                 $row = $link->query($sql);
                 if($row->num_rows>0){
                   ?>
                   <script>
                   ...
                   $sql="INSERT INTO `cat_destination`(`name`) VALUES ('$name')";
