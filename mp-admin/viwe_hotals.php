                    			...
                    			<div class="card-content">
                    				<div class="card-actions">
                    					...
                    					<button type="button" class="btn btn-success btn-simple" rel="tooltip" data-placement="bottom" title="" data-original-title="Edit">
                    						<i class="material-icons"><a href="edit_hotal.php?id=<?php echo base64_encode($row['hotal_id']); ?>">edit</a> </i>
                    					<div class="ripple-container"></div></button>
                    					<button type="button" class="btn btn-danger btn-simple" rel="tooltip" data-placement="bottom" title="" data-original-title="Remove">
                    						<i class="material-icons"><a href="deleat_hotal.php?id=<?php echo base64_encode($row['hotal_id']); ?>">delete</a> </i>
                    					<div class="ripple-container"></div></button>
                    				</div>

                    				<h4 class="card-title">
                    					<a href="#pablo"><?php echo $row['hotal_name']; ?></a>
                    				</h4>
