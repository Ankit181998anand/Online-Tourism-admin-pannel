	...
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-content">
				<h4 class="card-title">Edit Shop (<?php echo $data['shop_name']; ?>)</h4>
        <div class="float-right">
          <a href="view_shop.php"><button type="button" class="btn btn-danger" name="button">Back</button></a>
					...
					<form method="post" action="" enctype="multipart/form-data">
	                    ...
	                    <div class="form-group label-floating ">
	                        ...
	                        <input type="text"name="name" value="<?php echo $data['shop_name']; ?>" class="form-control">
	                    <span class="material-input"></span></div>

                      <div class="form-group label-floating ">
	                        <label class="control-label">Description</label>
	                        <textarea  name="add"   rows="10"  class="form-control"><?php echo $data['address']; ?></textarea>
	                    <span class="material-input"></span></div>


                      <div class="form-group label-floating ">
	                        <label class="control-label">State</label>
	                        <input type="text"name="state" value="<?php echo $data['states']; ?>" class="form-control">
	                    <span class="material-input"></span></div>
                      <div class="form-group label-floating">
	                        <label class="control-label">Rating</label>
	                        <input type="text"name="rate" value="<?php echo $data['rating']; ?>" class="form-control">
	                    <span class="material-input"></span></div>


                      <div class="fileinput text-center fileinput-new" data-provides="fileinput">
  								<div class="fileinput-new thumbnail">
  									<img src="./middleware/media/images/<?php echo $data['img']; ?>" alt="...">
  								</div>
        ...
        if(isset($_FILES['image'])){
          ...
          if ($i_s1==1) {
            echo $i_s1;
            $sql="UPDATE `shop_reg` SET `shop_name`='$name',`address`='$add',`states`='$state',`rating`='$rate ',`img`='$file_name1' WHERE shop_id='$id'";
