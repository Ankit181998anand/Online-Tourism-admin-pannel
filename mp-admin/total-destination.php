                    			...
                    			<div class="card-content">
                    				<div class="card-actions">
                    					...
                    					<button type="button" class="btn btn-success btn-simple" rel="tooltip" data-placement="bottom" title="" data-original-title="Edit">
                    						<i class="material-icons"><a href="edit-des.php?id=<?php echo base64_encode($row['id']); ?>">edit</a> </i>
                    					<div class="ripple-container"></div></button>
                    					<button type="button" class="btn btn-danger btn-simple" rel="tooltip" data-placement="bottom" title="" data-original-title="Remove">
                    						<i class="material-icons"><a href="remove-des.php?id=<?php echo base64_encode($row['id']); ?>">delete</a> </i>
                    					<div class="ripple-container"></div></button>
                    				</div>
                              ...
                              <?php echo substr($row['description'],0,80)."..."; ?>
                    			...
                    			<div class="card-footer">
                    				...
                    				<div class="stats pull-right">
                    					<p class="category"><i class="material-icons">place</i> <?php echo $row['state']; ?>, India</p>
                    				</div>
                    			</div>
                    		</div>
                    	</div>
