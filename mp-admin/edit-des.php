	...
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-content">
				<h4 class="card-title">Edit Destination (<?php echo $data['title']; ?>)</h4>
        <div class="float-right">
          <a href="total-destination.php"><button type="button" class="btn btn-danger" name="button">Back</button></a>
        ...
        if(isset($_FILES['image'])){
          ...
          if ($i_s1==1) {
            ...
            $sql="UPDATE `destinations` SET `title`='$title', `description`='$des', `price`='$cost',`state`='$state' , `image`='$file_name1' WHERE id='$id'";
...
text: "Destination Modified successfully",
type: "success",
confirmButtonText: "Ok"
}, function() {
window.location = "./total-destination.php";
}, 1000);
});
</script>
<?php
