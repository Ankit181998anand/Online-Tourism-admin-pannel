	...
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-content">
				<h4 class="card-title">Edit Hotal (<?php echo $data['hotal_name']; ?>)</h4>
        <div class="float-right">
          <a href="viwe_hotals.php"><button type="button" class="btn btn-danger" name="button">Back</button></a>
					...
					<form method="post" action="" enctype="multipart/form-data">
	                    ...
	                    <div class="form-group label-floating ">
	                        ...
	                        <input type="text"name="name" value="<?php echo $data['hotal_name']; ?>" class="form-control">
        ...
        if(isset($_FILES['image'])){
          ...
          if ($i_s1==1) {
            echo $i_s1;
            $sql="UPDATE `hotal` SET `hotal_name`='$name',`address`='$add',`states`='$state',`rating`='$rate',`image`='$file_name1' WHERE `hotal_id`='$id'";
